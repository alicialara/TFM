...
<head>
    ...
    <link href="<?php echo URL_BASE_PUBLIC; ?>/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo URL_BASE_PUBLIC; ?>/css/animate.css" rel="stylesheet">
    <link href="<?php echo URL_BASE_PUBLIC; ?>/css/style.css" rel="stylesheet">
    <!-- Styles -->
    <link href="<?php echo URL_BASE_PUBLIC; ?>/css/app.css" rel="stylesheet">
    <!-- Scripts -->
    <script>
...
<body>
    ...
    <!-- Scripts -->
    <script src="<?php echo URL_BASE_PUBLIC; ?>/js/app.js"></script>
</body>
<footer>
    <!-- Mainly scripts -->
